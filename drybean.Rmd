...
Created an algorithm for selecting a minimal set of features that maximizes the
accuracy of a model.

Two of the models report the importance of each feature in their
classifications. I compare the sets of important features to the sets resulting
from the minimal set construction. Finally, I calculate the accuracy of the five
models on the four sets of features using the reserved test set.
